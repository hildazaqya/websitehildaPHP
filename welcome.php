...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id = "headeratas2">
      ...
      <div class="row">
                  ...
                  <div class="col-md-6">
                      <p>Name: <?php echo $_POST["Nama"]; ?></p>
                      <p>Address: <?php echo $_POST["Alamat"]; ?></p>
                      <p>Telephone: <?php echo $_POST["Nomor_telepon"]; ?></p>
                      <p>Order 1: <?php echo $_POST["Pesanan1"]; ?></p>
                      <p>Order 2: <?php echo $_POST["Pesanan2"]; ?></p>
                      <p>Shipping Options: <?php echo $_POST["Opsi_pengiriman"]; ?></p>
                      <p> Payment via: <?php echo $_POST["Pembayaran"]; 
            ...
            <div class= "text-center" style="background-color: #f9f2d8;">
                <marquee><h1>THANKS<br>FOR SHOPPING!<h1></marquee>
                    </div>
              ...
              <section>
                <div class="row">
                  <div class="col-md-4 mt-auto mb-auto">
                    <h1  id = "footer1">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M9 23C8.45 23 8 22.55 8 22V13C8 12.45 8.45 12 9 12H15C15.55 12 16 12.45 16 13V22C16 22.55 15.55 23 15 23H9M10 11C9.45 11 9 10.55 9 10V5.25C9 5.25 11 3 11.75 1C12.83 1.67 13.92 2.33 14.46 3.83C15 5.33 15 7.67 15 10C15 10.55 14.55 11 14 11H10Z" />
                    </svg>
                    Helyoulips</h1>
